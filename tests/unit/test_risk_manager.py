...
class TestKillSwitch:
    ...
    def test_kill_switch_file_exists_default_path(self, tmp_path):
        ...
        with patch("trade_engine.domain.risk.risk_manager.KILL_SWITCH_FILE_PATH", str(kill_file)):
            rm = RiskManager(config)
...
class TestTradingHours:
    ...
    def test_normal_hours_inside_range(self):
        ...
        with patch("trade_engine.domain.risk.risk_manager.datetime") as mock_datetime:
