...
from trade_engine.services.data.web3_signals import (
    Web3DataSource,
    GasData,
    LiquidityData,
    FundingRateData,
...
class TestGasPrices:
    ...
    @patch('trade_engine.services.data.web3_signals.requests.Session')
...
class TestConvenienceFunction:
    ...
    @patch('trade_engine.services.data.web3_signals.Web3DataSource')
