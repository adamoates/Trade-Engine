...
from app.adapters.feed_binance_us_l2 import BinanceUSL2Feed, BinanceUSL2FeedError
...
class TestFetchSnapshot:
    ...
    @pytest.mark.asyncio
    @patch("app.adapters.feed_binance_us_l2.requests.get")
...
class TestContextManager:
    ...
    async def test_context_manager(self, mock_get):
        ...
        from app.adapters.feed_binance_us_l2 import BinanceUSL2FeedContext
